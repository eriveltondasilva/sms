...
type PageGroupTeacherCreateProps = {
  group: Group
  teachers: Teacher[]
}

export default function PageGroupTeacherCreate({
  group,
  teachers,
  flash,
}: PageProps<PageGroupTeacherCreateProps>) {
...
function TeacherTable({ group, teachers }: PageGroupTeacherCreateProps) {
